...
class LibreHardwareMonitor:
    '''
    Clase para interactuar con Libre Hardware Monitor.
    '''

    def _esta_libre_hardware_monitor_activo(self):
        '''
        ...
        for proceso in psutil.process_iter(['name', 'exe']):
            try:
                ...
                if proceso.info['name'] == 'LibreHardwareMonitor.exe':
                    ...
                    # * Se compara la ruta del ejecutable en ejecución con la
                    # * ruta del ejecutable local. Si son diferentes, se agrega
                    # * True al list.
                ...
                print(
                    ...
                    'suficientes para verificar si Libre Hardware Monitor '
                    'está activo ***'
                )
                print(
                ...
                # * Si se tienen permisos insuficientes para verificar el
                # * proceso, se finaliza el agente.
                sys.exit(1)
    ...
    def _configurar_libre_hardware_monitor(self):
        '''
        ...
        '''
        # * Se obtiene el directorio de trabajo actual como una ruta absoluta
        # * para buscar el archivo de configuración.
        ...
        try:
            ...
            # * Se itera sobre los ajustes de configuración que están en el
            # * XML, ahora convertidos a un objeto de tipo ElementTree.
            ...
            # * Se sobreescribe el archivo de configuración con los nuevos
            # * ajustes.
    ...
    def iniciar_libre_hardware_monitor(self):
        ...
        try:
            inspeccion_instancia = self._esta_libre_hardware_monitor_activo()

            # * Se verifica si Libre Hardware Monitor ya está en ejecución. Si
            # * ya lo está, no se vuelve a iniciar.
            if inspeccion_instancia['esta_activo']:
                print(
                    f'{datetime.now()} >>> *** Libre Hardware Monitor ya está '
                    'en ejecución ***'
                )

                # * Si la instancia ejecutada es externa al proyecto,
                # * verificando si hay un valor True en el list, se notifica al
                # * usuario.
                if True in inspeccion_instancia['hay_instancias_externas']:
                    print(
                        f'{datetime.now()} >>> *** Libre Hardware Monitor '
                        'está en ejecución como una instancia externa al '
                        'proyecto ***'
                    )
                    print(
                ...
                # * Se ejecuta el comando de PowerShell para iniciar Libre
                # * Hardware Monitor con privilegios de administrador.
                subprocess.run(
                ...
                # * Se configura Libre Hardware Monitor para que se inicie con
                # * los ajustes deseados.
                self._configurar_libre_hardware_monitor()
        except Exception as error:
            print(
